# morrow-decision-compiler: Architecture & System Topology

**Domain**: Evidence-Grounded Decision Intelligence: RAG & Causal Futures  
**Description**: Evidence-grounded decision compiler combining causal DAG topological inference, Monte Carlo risk variance, and SQL provenance audits.
...
sequenceDiagram
    ...
    participant Engine as morrow-decision-compiler Core
